...
public class ProgrammingTest_Question1 {
  ...
  public static void main(String[] args) {
    Scanner sc=new Scanner(System.in); // initializing Scanner to scan for inputs
		System.out.println("The program prints the volume, surface area and circumference of a capsule\n having radius r ranging from 6 to N in increments of 6 and side length a");
		System.out.print("Enter the value for N: ");
		int valueN=sc.nextInt(); // Reading radius
		System.out.print("Enter the length of side a: ");
		double valueA=sc.nextDouble(); // Reading side
		System.out.printf("%-12s\t%-10s\t%-12s\t%-12s\n","Radius","Volume","Surface Area","Circumference");
		System.out.println("-------------------------------------------------------------");
		
		for (int i = 6; i < valueN ; i += 6) //for loop to calculate the Volume, Surface area and Circumference of the capsule and display in the desired format
		{
